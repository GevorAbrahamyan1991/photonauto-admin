    ...
    <div class="container" id="home_admin_section_phone_email">
        <div class="row">
            ...
            <div class="col-md-12 mt-5">
                <form
                    action="{{ route('admin.LampBrand.update',$LampBrands->id) }}"
                    method="POST"
                    class="w-100"
                ...
                >
                    ...
                    @method('PUT')
                    <label>
                        <input type="text" value="{{ $LampBrands->lamp_brand }}" name="lamp_brand" id="name" required>
                        <div class="label-text">Lamp Brand</div>
                    </label>
