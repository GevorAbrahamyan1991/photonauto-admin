...
@section('title', 'Edit Lamp Post')
@section('content')
    <div class="max-w-screen-lg mx-auto">
        <form action="{{ route('admin.lamps.update', ['id' => $lamps->id]) }}" enctype="multipart/form-data" method="POST"
            class="my-6">
            @method('PUT')
            @csrf
            <div class="grid gap-y-4">
                ...
                <div class="">
                    ...
                    <input type="text" name="title_en" id="title_en" value="{{ $lamps->title_en }}"
                ...
                <div class="">
                    ...
                    <input type="text" name="title_ru" id="title_ru" value="{{ $lamps->title_ru }}"
                        class="block w-full text-sm text-gray-900 border border-gray-300  cursor-pointer bg-gray-50  focus:outline-none rounded-lg">
                </div>
                <div class="">
                    <label class="block mb-2 text-2xl font-bold font-serif text-white" for="title_am">Title Am</label>
                    <input type="text" name="title_am" id="title_am" value="{{ $lamps->title_am }}"
                        class="block w-full text-sm text-gray-900 border border-gray-300  cursor-pointer bg-gray-50  focus:outline-none rounded-lg">
                </div>
                <div class="mb-6">
